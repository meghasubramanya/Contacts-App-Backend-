...
public class ContactList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Backendless.Persistence.of(Contact.class).find(queryBuilder, new AsyncCallback<List<Contact>>() {
            ...
            public void handleResponse(List<Contact> response) {
                ...
                contactsAdapter=new ContactsAdapter(ContactList.this,ApplicationClass.contacts);
                lvList.setAdapter(contactsAdapter);
                showProgress(false);
            }
    ...
    //explicit intent to get back to this page and change the list if deleted/edited.
