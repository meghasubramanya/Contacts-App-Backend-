    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(etName.getText().toString().isEmpty()||etNumber.getText().toString().isEmpty()||etMail.getText().toString().isEmpty())
                {
                ...
                else
                {
                    ...
                    showProgress(true);
                    tvLoad.setText("Adding new contact...please wait...");

                    Backendless.Persistence.save(contact, new AsyncCallback<Contact>() {
                        @Override
                        public void handleResponse(Contact response) {

                            Toast.makeText(NewContact.this, "Contact successfully saved!", Toast.LENGTH_SHORT).show();
                            showProgress(false);
