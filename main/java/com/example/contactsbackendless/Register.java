        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else
                {
                    if(etPassword.getText().toString().trim().equals(etReEnter.getText().toString().trim()))
                    {
                        ...
                        Backendless.UserService.register(user, new AsyncCallback<BackendlessUser>() {
                            ...
                            public void handleResponse(BackendlessUser response) {
                                ...
                                Register.this.finish();       //goes to prev activity(login) and this ends.
                            }
                    ...
                    {
                        Toast.makeText(Register.this, "Please make sure that the password and re-type password is the same!", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
